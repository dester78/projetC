...
//Fonction centrant un rectangle dans un rectangle selon un axe donné
void centerRectOnRect(SDL_Rect *targetRect, SDL_Rect *centeredRect, Axe axe);

//Fonction centrant un point dans un rectangle selon un axe donné
void centerPointOnRect(SDL_Rect *targetRect, SDL_Point *centeredPoint, Axe axe);

//Fonction centrant un rectangle sur un point
...
//Fonction modifiant une paire de point en fonction d'un rectangle enfant et d'un rectangle parent 
