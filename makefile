...
SDLMain.o: $(H_DIR)/SDLmain.h $(S_DIR)/SDLmain.c $(H_DIR)/SDLColor.h  $(H_DIR)/structures.h  $(H_DIR)/SDLConfigStructures.h  $(H_DIR)/SDLObjectsStructures.h $(H_DIR)/SDLObjects.h $(H_DIR)/SDLDraw.h $(H_DIR)/SDLGUIObjects.h  $(H_DIR)/SDLMetroStation.h $(H_DIR)/SDLBackgroundObjects.h $(H_DIR)/SDLRectPoint.h $(H_DIR)/SDLTimer.h $(H_DIR)/SDLMetroLine.h 
...
SDLBackgroundObjects.o: $(H_DIR)/SDLBackgroundObjects.h $(S_DIR)/SDLBackgroundObjects.c $(H_DIR)/SDLObjectsStructures.h  $(H_DIR)/SDLRectPoint.h  $(H_DIR)/SDLGUIObjects.h  $(H_DIR)/mathCalculation.h  $(H_DIR)/SDLColor.h
	$(CC)   -o SDLBackgroundObjects.o -c $(S_DIR)/SDLBackgroundObjects.c $(CFLAGS) $(CPPFLAGS)

SDLMetroStation.o: $(H_DIR)/SDLMetroStation.h $(S_DIR)/SDLMetroStation.c $(H_DIR)/SDLBackgroundObjects.h $(H_DIR)/SDLObjectsStructures.h  $(H_DIR)/SDLRectPoint.h  $(H_DIR)/SDLGUIObjects.h  $(H_DIR)/mathCalculation.h  $(H_DIR)/SDLColor.h $(H_DIR)/SDLMetroLine.h
	$(CC)   -o SDLMetroStation.o -c $(S_DIR)/SDLMetroStation.c $(CFLAGS) $(CPPFLAGS)


SDLTransport.o: $(H_DIR)/SDLTransport.h $(S_DIR)/SDLTransport.c $(H_DIR)/SDLBackgroundObjects.h $(H_DIR)/SDLObjectsStructures.h  $(H_DIR)/SDLRectPoint.h  $(H_DIR)/SDLGUIObjects.h  $(H_DIR)/mathCalculation.h  $(H_DIR)/SDLColor.h $(H_DIR)/SDLMetroLine.h
...
SDLMetroLine.o: $(H_DIR)/SDLMetroLine.h $(S_DIR)/SDLMetroLine.c $(H_DIR)/SDLRectPoint.h $(H_DIR)/SDLMetroStation.h
...
SDLTimer.o: $(H_DIR)/SDLTimer.h $(S_DIR)/SDLTimer.c $(H_DIR)/SDLObjectsStructures.h $(H_DIR)/SDLMetroStation.h $(H_DIR)/SDLMetroLine.h $(H_DIR)/SDLTransport.h 
