...
$(EXEC): dbManager.o  fileManager.o structures.o SDLColor.o SDLMain.o main.o formatString.o SDLConfigStructures.o SDLObjectsStructures.o SDLObjects.o SDLDraw.o  mathCalculation.o SDLGUIObjects.o SDLRectPoint.o SDLBackgroundObjects.o SDLMetroLine.o SDLTimer.o
	$(CC) $(CFLAGS) -o $(EXEC)  formatString.o fileManager.o structures.o dbManager.o SDLMain.o SDLConfigStructures.o  SDLObjectsStructures.o SDLObjects.o SDLDraw.o mathCalculation.o SDLGUIObjects.o SDLRectPoint.o SDLBackgroundObjects.o SDLColor.o main.o  SDLMetroLine.o SDLTimer.o $(LDFLAGS) $(CPPFLAGS)  $(LDLIBS)
...
SDLMain.o: $(H_DIR)/SDLmain.h $(S_DIR)/SDLmain.c $(H_DIR)/SDLColor.h  $(H_DIR)/structures.h  $(H_DIR)/SDLConfigStructures.h  $(H_DIR)/SDLObjectsStructures.h $(H_DIR)/SDLObjects.h $(H_DIR)/SDLDraw.h $(H_DIR)/SDLGUIObjects.h $(H_DIR)/SDLBackgroundObjects.h $(H_DIR)/SDLRectPoint.h $(H_DIR)/SDLTimer.h 
...
SDLObjects.o: $(H_DIR)/SDLObjects.h $(S_DIR)/SDLObjects.c  $(H_DIR)/SDLConfigStructures.h  $(H_DIR)/SDLObjectsStructures.h 
	$(CC)   -o SDLObjects.o -c $(S_DIR)/SDLObjects.c $(CFLAGS) $(CPPFLAGS)

SDLBackgroundObjects.o: $(H_DIR)/SDLBackgroundObjects.h $(S_DIR)/SDLBackgroundObjects.c  $(H_DIR)/SDLObjectsStructures.h  $(H_DIR)/SDLRectPoint.h  $(H_DIR)/SDLGUIObjects.h  $(H_DIR)/mathCalculation.h  $(H_DIR)/SDLColor.h $(H_DIR)/SDLMetroLine.h
	$(CC)   -o SDLBackgroundObjects.o -c $(S_DIR)/SDLBackgroundObjects.c $(CFLAGS) $(CPPFLAGS)

SDLGUIObjects.o: $(H_DIR)/SDLGUIObjects.h $(S_DIR)/SDLGUIObjects.c  $(H_DIR)/SDLObjectsStructures.h $(H_DIR)/SDLColor.h $(H_DIR)/SDLDraw.h
...
SDLColor.o: $(H_DIR)/SDLColor.h $(S_DIR)/SDLColor.c 
	$(CC)   -o SDLColor.o -c $(S_DIR)/SDLColor.c $(CFLAGS) $(CPPFLAGS)

SDLRectPoint.o: $(H_DIR)/SDLRectPoint.h $(S_DIR)/SDLRectPoint.c  $(H_DIR)/SDLObjectsStructures.h
	$(CC)   -o SDLRectPoint.o -c $(S_DIR)/SDLRectPoint.c $(CFLAGS) $(CPPFLAGS)

SDLMetroLine.o: $(H_DIR)/SDLMetroLine.h $(S_DIR)/SDLMetroLine.c $(H_DIR)/SDLRectPoint.h
	$(CC)   -o SDLMetroLine.o -c $(S_DIR)/SDLMetroLine.c $(CFLAGS) $(CPPFLAGS)

SDLDraw.o: $(H_DIR)/SDLDraw.h $(S_DIR)/SDLDraw.c $(H_DIR)/SDLObjectsStructures.h
	$(CC)   -o SDLDraw.o -c $(S_DIR)/SDLDraw.c $(CFLAGS) $(CPPFLAGS)

SDLTimer.o: $(H_DIR)/SDLTimer.h $(S_DIR)/SDLTimer.c $(H_DIR)/SDLObjectsStructures.h $(H_DIR)/SDLBackgroundObjects.h
	$(CC)   -o SDLTimer.o -c $(S_DIR)/SDLTimer.c $(CFLAGS) $(CPPFLAGS)

mathCalculation.o: $(H_DIR)/mathCalculation.h $(S_DIR)/mathCalculation.c $(H_DIR)/SDLObjectsStructures.h
